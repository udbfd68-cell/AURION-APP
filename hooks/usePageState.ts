...
export function usePageState() {
  ...
  const pageProps: Record<string, any> = {
    ...
    breakpointTestIdx, brokenLinks, browser21stInputRef, browser21stLoading, browser21stQuery, browser21stResults, 
    buildWorkspaceContext, bundleEstimate, capturePreviewScreenshot, changeSummary, chatDragRef, chatEndRef, chatWidth, 
    clearChat, cloneError, cloneProgress, cloneUrl, cloneWebsite, clonedHtml, closeTab, codeBlocks, codeComplexity, 
    ...
    isDragOver, isEditMode, isExplaining, isFileModified, isGitHubPushing, isLandscape, isRefining, isResearching, 
    ...
    runPerfAudit, runSchemaTemplate, runSupabaseQuery, runTerminalCommand, runTestsInContainer, runtimeErrors, 
    ...
    setChatWidth, setCloneError, setCloneUrl, setClonedHtml, setCodeReviewLoading, setCodeReviewResult, 
  ...
  return { pageProps,
    ...
    breakpointTestActive, breakpointTestIdx, brokenLinks, browser21stInputRef, browser21stLoading, browser21stQuery,
    browser21stResults, buildFileTree, buildWorkspaceContext, bundleEstimate,
    capturePreviewScreenshot, changeSummary, chatDragRef, chatEndRef, chatWidth, clearChat, clonedHtml,
    ...
    isDeploying, isDragOver, isEditMode, isExplaining, isFileModified, isGitHubPushing, isLandscape, isRefining,
    ...
    runSchemaTemplate, runSupabaseQuery, runTerminalCommand, runTestsInContainer, runtimeErrors, sandboxDb,
    ...
    setBackendEntityName, setBackendGeneratedFiles, setBackendPreset, setBookmarkedLines, setBookmarks,
    setBreakpointTestActive, setBreakpointTestIdx, setBrowser21stLoading, setBrowser21stQuery, setBrowser21stResults,
    setChatWidth, setClonedHtml, setCloneError, setCloneUrl, setCodeReviewLoading, setCodeReviewResult,
    setCollabChatInput, setCollabChatMessages, setCollabJoinInput, setCollabMode, setCollabRoomId, setCollabUsers,
    setColorEditTarget, setColorEditValue, setCommandIdx, setCommandQuery, setConsoleFilterLevel, setConsoleLogs,
    setContentSearchQuery, setConversations, setCurrentProjectId, setCursorPosition, setDbActiveConnection,
    setDbQueryHistory, setDbQueryResult, setDbQueryRunning, setDbSchema, setDbSchemaLoading, setDbSchemaTemplate,
