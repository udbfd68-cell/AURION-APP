...
export function usePageState() {
  ...
  const pageProps: Record<string, any> = {
    ...
    preview21stComponent, previewDarkMode, previewHtml, previewLoading, previewZoom, projectFiles, 
    ...
    setPreview21stComponent, setPreviewDarkMode, setPreviewLoading, setPreviewZoom, setProjectFiles, setProjects, 
  ...
  return { pageProps,
    ...
    prevFilesRef, preview21stComponent, previewDarkMode, previewHtml, previewLoading, previewZoom, projectFiles, projects, projectStats,
    ...
    setMediaAssets, setMessages, setMinimapEnabled, setModel, setNewEnvKey, setNewEnvValue, setNewFileName,
    setOnboardingStep, setOpenTabs, setOutputFramework, setPendingPrompt, setPerfIssues, setPickedColor,
    setPreview21stComponent, setPreviewDarkMode, setPreviewLoading, setPreviewZoom, setProjectFiles, setProjects, setRefineFeedback,
